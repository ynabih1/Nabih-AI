with open('app/src/main/java/com/example/ui/screen/MainScreen.kt', 'r', newline='') as f:
    code = f.read()
...
with open('app/src/main/java/com/example/ui/screen/MainScreen.kt', 'w', newline='\n') as f:
    f.write(code)
