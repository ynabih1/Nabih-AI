...
class ChatViewModel(
    ...
    private fun handleError(e: Throwable, convId: String) {
        ...
        val isArabic = settingsRepository.settings.value.language == com.example.model.AppLanguage.ARABIC
        val userMsg = com.example.data.remote.AiErrorTranslator.translate(
            throwable = e,
