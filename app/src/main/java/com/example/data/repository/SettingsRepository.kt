...
class SettingsRepository(context: Context) {
    ...
    private val secureStorage = com.example.utils.SecureStorage(context)
    ...
    private val userAccountDao by lazy {
        com.example.data.local.AppDatabase.getDatabase(context).userAccountDao()
    }
    ...
    suspend fun registerUser(email: String, name: String, passwordHash: String): Boolean {
        ...
        val newUser = com.example.data.local.UserAccount(
            email = trimmedEmail,
            name = name.trim(),
